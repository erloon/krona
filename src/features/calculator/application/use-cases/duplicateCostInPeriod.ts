...
export async function duplicateCostInPeriodUseCase(
  ...
  const duplicateCost = createCost({
    ...
    nip: sourceCost.nip,
    supplierName: sourceCost.supplierName,
    supplierAddress: sourceCost.supplierAddress,
    enteredNetAmount: sourceCost.enteredNetAmount,
    currency: sourceCost.currency,
